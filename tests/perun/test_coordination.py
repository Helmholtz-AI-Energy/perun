...
# from perun.coordination import getHostRankDict, assignSensors
...
#     comm.allgather = MagicMock(return_value=[(hostnames_list[rank], rank) for rank in range(world_size)])
